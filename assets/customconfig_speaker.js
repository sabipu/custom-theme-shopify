var config = {
  ...
  default_uri: "c=1&cable-brand=klotz&cable-type=klotz_4core_4_0mm&cable-length=10&connectorA-brand=neutrik&connectorA-connector=connector_neutrik_speakOn_NL4FX_grey&connectorB-brand=neutrik&connectorB-connector=connector_neutrik_speakOn_NL4FX_grey",
  url_slug: "/pages/speaker-configurator",
  item_property_slug: "Custom Speaker Cable",
};
var orderLines = [];
var orderLinesData = [];
...
function changeImage (imageOptions)
{
  ...
  if(imageOptions.group == "cable" && imageOptions.slug != image[imageOptions.group] && typeof image["sleeve"] == "undefined")
  {
    ...
    preloadImages(
      ...
      function ()
      {
        ...
        toggleAndStoreClassForUpdateImage($('#cable_side_b_cable'), imageOptions.slug, "productImage_cable_speaker", imageOptions);
        toggleAndStoreClassForUpdateImage($('#cable_side_a_cable'), imageOptions.slug, "productImage_cable_speaker", imageOptions);
  ...
  if(imageOptions.group == "connectorA" && imageOptions.slug != image[imageOptions.group])
  {
    preloadImages(
        ...
        function ()
        {
          toggleAndStoreClassForUpdateImage($('#cable_side_a_connector'), imageOptions.slug, "productImage_cable_speaker", imageOptions);
  ...
  if(imageOptions.group == "connectorB" && imageOptions.slug != image[imageOptions.group])
  {
    preloadImages(
        ...
        function ()
        {
          toggleAndStoreClassForUpdateImage($('#cable_side_b_connector'), imageOptions.slug, "productImage_cable_speaker", imageOptions);
